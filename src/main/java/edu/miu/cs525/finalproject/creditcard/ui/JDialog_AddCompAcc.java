...
import edu.miu.cs525.finalproject.creditcard.model.*;
import edu.miu.cs525.finalproject.creditcard.service.CreditCardServiceImpl;
import edu.miu.cs525.finalproject.creditcard.strategy.BronzeCreditCardStrategy;
...
public class JDialog_AddCompAcc extends javax.swing.JDialog {
    ...
    public JDialog_AddCompAcc(CardFrm parent, CommandInvoker commandInvoker) {
        super(parent);
        parentframe = parent;
        ...
        //{{REGISTER_LISTENERS
        JDialog_AddCompAcc.SymMouse aSymMouse = new JDialog_AddCompAcc.SymMouse();
        JRadioButton_Gold.addMouseListener(aSymMouse);
        JRadioButton_Silver.addMouseListener(aSymMouse);
        JDialog_AddCompAcc.SymAction lSymAction = new JDialog_AddCompAcc.SymAction();
...
//        accountService.createAccount(creditCard);
        commandInvoker.getCommand("CREATE_CREDIT_CARD_ACCOUNT").execute(account);
