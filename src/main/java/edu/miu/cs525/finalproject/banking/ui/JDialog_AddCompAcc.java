...
public class JDialog_AddCompAcc extends JDialog
{
	...
	public JDialog_AddCompAcc(BankFrm parent, CommandInvoker commandInvoker)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) throws Exception {
       ...
       parentframe.state=JTextField_ST.getText();
		...
		if (JRadioButton_Chk.isSelected()) {
			...
			accountInterestType = AccountInterestType.CHECKING;
			interestStrategy = new CheckingInterestStrategy();
		} else {
			parentframe.accountType="S";
			accountInterestType = AccountInterestType.SAVING;
			interestStrategy = new SavingInterestStrategy();
		}
	   parentframe.newaccount=true;

		// create factory
		CustomerFactory customerFactory = new CompanyCustomerFactory();
		AccountFactory accountFactory = new CompanyAccountFactory();
...
//		accountService.createAccount(account); // goes to concrete command class
		commandInvoker.getCommand("CREATE_ACCOUNT").execute(account);
	   dispose();
