...
public class JDialog_Withdraw extends JDialog
{
	...
	public JDialog_Withdraw(BankFrm parent, String aaccnr, CommandInvoker commandInvoker)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
...
//		accountService.withdraw(accnr, Double.parseDouble(parentframe.amountDeposit));
		commandInvoker.getCommand("ACCOUNT_WITHDRAW").execute(accnr, parentframe.amountDeposit);
		dispose();
	}
