...
public class JDialog_Deposit extends JDialog
{
	...
	public JDialog_Deposit(BankFrm parent, String aaccnr, CommandInvoker commandInvoker)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) throws Exception {
		...
		// deposit money
//		accountService.deposit(accnr, Double.parseDouble(parentframe.amountDeposit));
		commandInvoker.getCommand("ACCOUNT_DEPOSIT").execute(accnr, parentframe.amountDeposit);
